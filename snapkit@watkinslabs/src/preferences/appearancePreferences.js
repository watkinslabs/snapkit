...
export class AppearancePreferences {
    ...
    _createColorSettings(parent) {
        ...
        this._createColorRow(section, 'Active Template Border', 'activeLayoutBorderColor', this._settings.activeLayoutBorderColor);
        this._createColorRow(section, 'Active Template Text', 'activeLayoutTextColor', this._settings.activeLayoutTextColor);
    }
