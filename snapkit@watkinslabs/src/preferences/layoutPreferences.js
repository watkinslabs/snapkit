...
export class LayoutPreferences {
    ...
    _exportLayouts() {
        ...
        try {
            ...
            const exportDir = GLib.build_filenamev([homeDir, '.local', 'share', 'snapkit-layouts']);
            ...
            const filename = `snapkit-layouts-${timestamp}.json`;
    ...
    _showMessage(message, type) {
        ...
        const timeoutId = GLib.timeout_add(GLib.PRIORITY_DEFAULT, 3000, () => {
            ...
            try {
                ...
                // Message box may already be destroyed
            }
